...
organizations:
  - name: Northwestern Polytechnical University
    url: https://hcps.nwpu.edu.cn/

# Social network links
# Need to use another icon? Simply download the SVG icon to your `assets/media/icons/` folder.
profiles:
  - icon: at-symbol
    url: 'guoyf@mail.nwpu.edu.cn'
    label: E-mail Me
  - icon: academicons/google-scholar
    url: https://scholar.google.com/citations?user=DnrQi0cAAAAJ&hl=zh-CN&oi=ao
  - icon: academicons/orcid
    url: https://orcid.org/0009-0009-0284-8965
  - icon: brands/github
    url: https://github.com/1YifanGuo
...
education:
  - area: M.Sc. in Computer Technology
    institution: Northwestern Polytechnical University
    date_start: 2021-09-01
    date_end: 2024-04-01

  - area: B.Eng. in Internet of Things
